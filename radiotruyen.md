...
The result will be a json on `window.cList` variable. It also being copied to clipboard, and can paster into [json-editor](https://jsoneditoronline.org/) for online formatting
